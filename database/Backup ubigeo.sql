...
MySQL - 10.4.24-MariaDB : Database - ubigeo
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`ubigeo` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/* Procedure structure for procedure `spu_listar_departamento` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_departamento` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_departamento`()
begin
	SELECT DISTINCT dpto FROM ubigeo;
end */$$
DELIMITER ;

/* Procedure structure for procedure `spu_listar_distrito` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_distrito` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_distrito`(IN _prov VARCHAR(32))
BEGIN
	SELECT ubigeo1, distrito FROM ubigeo WHERE prov = _prov;
END */$$
DELIMITER ;

/* Procedure structure for procedure `spu_listar_provincias` */

/*!50003 DROP PROCEDURE IF EXISTS  `spu_listar_provincias` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_listar_provincias`(IN _dpto VARCHAR(32))
BEGIN
	SELECT distinct prov FROM ubigeo WHERE dpto = _dpto;
END */$$
DELIMITER ;
